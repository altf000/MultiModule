...
import ru.altf000.multimodule.movie_detail.presentation.view.adapter.RecommendationsListAdapter
...
internal class MovieDetailFragment : BaseFragment(R.layout.fragment_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.contentInfoFlow.collectOnStarted(viewLifecycleOwner) { content ->
            setContentInfo(content)
        }
        viewModel.recommendationsFlow.collectOnStarted(viewLifecycleOwner) { recommendations ->
